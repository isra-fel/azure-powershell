...
2. Run todo: `name of the command Update-DevAssembly or Update-DevDependency` found in the AzDev module. Follow the instructions necessary to build and import the module first.
